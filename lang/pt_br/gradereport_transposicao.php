...
$string['invalid_grade_item_cagr'] = 'Tipo inválido para as notas finais (Nota Moodle). Elas devem ser do tipo \'Valor\' no intervalo entre 0 e 10.';
...
$string['warning_null_grade'] = 'Não há nota no Moodle. Será transposta nota/conceito:&nbsp;\'{$a}\'';

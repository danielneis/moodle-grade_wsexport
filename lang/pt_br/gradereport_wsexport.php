...
$string['can_send_user_and_course_heading'] = 'Permission checking call (user is allowed to send grade for this course?)';
$string['can_send_user_and_course_info'] = 'These settings let you configure the parameters to check if user can send grades of a course.';
$string['can_send_user_and_course_url_nome'] = 'Is allowed to send URL';
$string['can_send_user_and_course_url_msg'] = 'Full URL to webservice functon to check if user can send grades for a course.';
$string['can_send_user_and_course_function_name_nome'] = 'Is allowed to send function name';
$string['can_send_user_and_course_function_name_msg'] = 'Name of the function to check if user is allowed to send grades.';
$string['can_send_user_and_course_username_param_nome'] = 'Is allowed to send username parameter';
$string['can_send_user_and_course_username_param_msg'] = 'Name of the parameter of is allowed to send function that identifies the user who is sending the grades.';
$string['can_send_user_and_course_course_param_nome'] = 'Is allowed to send course parameter';
$string['can_send_user_and_course_course_param_msg'] = 'Name of the parameter of is allowed to send function that identifies the course for which the user is sending the grades.';

$string['can_send_grades_heading'] = 'Grades checking call (are the grades in the correct format to be sent?)';
$string['can_send_grades_info'] = 'These settings let you configure the parameters to check if grades are in correct format.';
$string['can_send_grades_url_nome'] = 'Is allowed to send URL';
$string['can_send_grades_url_msg'] = 'Full URL to webservice functon to check if user can send grades for a course.';
$string['can_send_grades_function_name_nome'] = 'Is allowed to send function name';
$string['can_send_grades_function_name_msg'] = 'Name of the function to check if user is allowed to send grades.';
$string['can_send_grades_username_param_nome'] = 'Is allowed to send username parameter';
$string['can_send_grades_username_param_msg'] = 'Name of the parameter of is allowed to send function that identifies the user who is sending the grades.';
$string['can_send_grades_course_param_nome'] = 'Is allowed to send course parameter';
$string['can_send_grades_course_param_msg'] = 'Name of the parameter of is allowed to send function that identifies the course for which the user is sending the grades.';

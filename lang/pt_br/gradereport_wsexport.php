...
$string['send_grades_url_msg'] = 'Full URL to webservice function to send grades';
...
$string['unformatted_grades_remote'] = 'Há pelo menos uma nota fora do padrão de arredondamento de notas da UFSC. Isto impede o envio de notas.
         (<A HREF="http://tutoriais.moodle.ufsc.br/notas/notas.htm" TARGET="_new">ver tutorial sobre configuração de notas</A>).';
